...
class _VideoPlayerKYCScreenState extends State<VideoPlayerKYCScreen> {
  ...
  Future<void> submitVideo(BuildContext context) async {
    ...
    try {
      // ✅ Video is already compressed — use path directly, no re-compression
      ...
      if (!await videoFile.exists()) {
        ...
        showDialog(
          ...
          builder: (context) => AlertDialog(
            title: Text('Note'),
            content: Text('Video file not found. Please re-record.'),
            actions: [
              ElevatedButton(
      ...
      print('📹 Video file size: ${fileSizeInKB.toStringAsFixed(2)} KB');
