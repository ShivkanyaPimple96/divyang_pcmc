...
class _VideoRecordKYCScreenState extends State<VideoRecordKYCScreen> {
  ...
  bool isCompressing = false; // ✅ NEW: track compression state
  ...
  Future<void> startVideoRecording() async {
    ...
    try {
      ...
      // ✅ Compress video here before navigating
      setState(() {
        isCompressing = true;
      });

      Fluttertoast.showToast(
        msg: "Uploading video, please wait...",
      ...
      if (compressedVideo.filesize! > 25 * 1024 * 1024) {
        Fluttertoast.showToast(
          msg: "Video is too large. Please record a shorter video.",
          backgroundColor: Colors.red,
          textColor: Colors.white,
        );
        return;
      ...
      final String compressedPath = compressedVideo.path!;

      Fluttertoast.showToast(
        msg: "Video Recorded & Uploaded!",
        backgroundColor: Colors.green,
        textColor: Colors.white,
      );

      // ✅ Pass compressedPath to VideoPlayerKYCScreen
      Navigator.push(
        context,
        MaterialPageRoute(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ElevatedButton.icon(
                                    onPressed: (isRecording || isCompressing)
                                        ? null
                                        : () async {
