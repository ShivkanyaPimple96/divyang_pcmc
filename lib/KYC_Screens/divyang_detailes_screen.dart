...
class _DivyangDetailesScreenState extends State<DivyangDetailesScreen> {
  ...
  // Edit mode flags
  bool _isAddressEditMode = false;
  bool _isUdidEditMode = false;
  bool _isDisabilityEditMode = false;
  bool _isGenderEditMode = false;
  ...
  void initState() {
    ...
    // Pre-populate address and UDID if available
    if (widget.addresss.isNotEmpty) {
      _addressController.text = widget.addresss;
    }
    if (widget.udidNumber.isNotEmpty) {
      _udidController.text = widget.udidNumber;
    }
    if (widget.disabilityType.isNotEmpty) {
      _selectedDisabilityType = widget.disabilityType;
    }
  ...
  // Helper method to check if data should be shown (read-only display)
  ...
  // Helper method to check if form fields should be shown (editable)
  bool get _shouldShowFormFields {
    return widget.verificationStatus != 'Verification In Progress' &&
        widget.verificationStatus != 'Application Approved';
  }

  // // Helper method to check if edit buttons should be shown for pre-populated data
  // bool get _shouldShowEditButtons {
  //   return widget.verificationStatus.isEmpty ||
  //       widget.verificationStatus == 'Application Rejected';
  // }
  // FIXED: Helper method to check if edit buttons should be shown for pre-populated data
  bool get _shouldShowEditButtons {
    // Edit buttons should only show when status is empty or rejected
    // Should NOT show when Verification In Progress or Application Approved
    return (widget.verificationStatus.isEmpty ||
            widget.verificationStatus == 'Application Rejected') &&
        widget.verificationStatus != 'Verification In Progress' &&
        widget.verificationStatus != 'Application Approved';
  }
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: height * 0.02),
                            _buildInfoCard(
                                'uniqueKey', widget.uniqueKey, width),
                            SizedBox(height: height * 0.02),
                            ...
                            if (_shouldShowUserData &&
                              ...
                              _buildEditableInfoCard(
                                ...
                                widget.addresss,
                                width,
                                isEditing: _isAddressEditMode,
                                controller: _addressController,
                                onEditPressed: () {
                                  setState(() {
                                    _isAddressEditMode = !_isAddressEditMode;
                                  });
                                },
                                maxLines: 3,
                              ),
                            ...
                            // UDID field with edit option for read-only view
                            if (_shouldShowUserData &&
                                widget.udidNumber.isNotEmpty) ...[
                              _buildEditableInfoCard(
                                'UDID Card Number',
                                widget.udidNumber,
                                width,
                                isEditing: _isUdidEditMode,
                                controller: _udidController,
                                onEditPressed: () {
                                  setState(() {
                                    _isUdidEditMode = !_isUdidEditMode;
                                  });
                                },
                              ),
                              SizedBox(height: height * 0.02),
                            ...
                            if (_shouldShowUserData &&
                              ...
                              _buildEditableDropdownCard(
                                'Type of Disability (अपंगत्वाचा प्रकार)',
                                widget.disabilityType,
                                width,
                                isEditing: _isDisabilityEditMode,
                                onEditPressed: () {
                                  setState(() {
                                    _isDisabilityEditMode =
                                        !_isDisabilityEditMode;
                                  });
                                },
                                ...
                                hint: 'Select Type of Disability',
                              ),
                              SizedBox(height: height * 0.02),
                            ],
                            ...
                            if (_shouldShowFormFields) ...[
                              ...
                              // Gender field - show with edit button if pre-populated
                              if (_shouldShowEditButtons &&
                                  widget.gender.isNotEmpty) ...[
                                _buildEditableDropdownCard(
                                  'Gender (लिंग)',
                                  widget.gender,
                                  width,
                                  isEditing: _isGenderEditMode,
                                  onEditPressed: () {
                                    setState(() {
                                      _isGenderEditMode = !_isGenderEditMode;
                                    });
                                  },
                                  ...
                                  onChanged: (newValue) {
                                    setState(() {
                                      ...
                                      if (_formSubmitted) {
                                        _showGenderError = newValue == null ||
                                            newValue.isEmpty;
                                      }
                                    });
                                  },
                              ...
                              // UDID field - show with edit button if pre-populated
                              if (_shouldShowEditButtons &&
                                  widget.udidNumber.isNotEmpty) ...[
                                _buildEditableInfoCard(
                                  'UDID Card Number (UDID कार्ड नंबर)',
                                  widget.udidNumber,
                                  width,
                                  isEditing: _isUdidEditMode,
                                  controller: _udidController,
                              ...
                              // Disability Type - show with edit button if pre-populated
                              if (_shouldShowEditButtons &&
                                  widget.disabilityType.isNotEmpty) ...[
                                _buildEditableDropdownCard(
                                  'Type of Disability (अपंगत्वाचा प्रकार)',
        ...
        children: [
          Row(
            ...
            children: [
              ...
              // if (_shouldShowEditButtons || _shouldShowUserData)
              if (_shouldShowEditButtons)
                InkWell(
                  onTap: onEditPressed,
                  child: Container(
          ...
          if (isEditing)
            TextFormField(
              ...
              decoration: InputDecoration(
                border: OutlineInputBorder(
                  ...
                  borderSide: BorderSide(color: Color(0xFFF76048), width: 2),
                ),
                focusedBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(width * 0.02),
            ...
            Text(
              controller.text.isNotEmpty ? controller.text : value,
              style: TextStyle(
                fontSize: width * 0.04,
                fontWeight: FontWeight.bold,
              ),
  ...
  Widget _buildEditableDropdownCard(
    String title,
    String value,
    double width, {
    required bool isEditing,
        ...
        children: [
          ...
          if (isEditing)
            DropdownButtonFormField<String>(
              ...
              onChanged: onChanged,
              hint: Text(hint, style: TextStyle(fontSize: width * 0.035)),
            )
          else
            Text(
              selectedValue ?? value,
...
//   final String gender;
//   final String disabilityType;
//   final String udidNumber; // Add this parameter
...
//     required this.verificationStatus,
//     required this.disabilityType,
//     this.udidNumber = '', // Add default value
//   });
...
//                             // Address field with edit option
//                             if (_shouldShowUserData &&
//                                 widget.addresss.isNotEmpty) ...[
//                               _buildEditableInfoCard(
//                                 'Address',
